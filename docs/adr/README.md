...
Both indexes below are complete: **36 decisions, no third home.** `consistency_lint.py`'s `adr-index`
...
**33** and item 4.4 to **36** — the count is maintained by hand on every pass, which is the standing
reason it drifts.)
