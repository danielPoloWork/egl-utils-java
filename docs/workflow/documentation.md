...
How documentation is maintained on `egl-utils-java`. Documentation is part of the
...
Public symbols are documented with `Javadoc`-compatible comments. The API-docs build
